...
sac = Trainer("default", "pendubot", "default", [SequenceSACPolicy], [MultiplePoliciesReplayBuffer], [default_decider], 42, None)
controller = sac.get_controller("/saved_model/saved_model_700000_steps")
controller.init()
