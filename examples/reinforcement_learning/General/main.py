...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default="conv_2")
    ...
    sac = Trainer(args.name, args.env_type, args.param, [ConvPolicy], [MultiplePoliciesReplayBuffer], [default_decider], seed, action_noise)
    ...
    if args.mode == "evaluate_korean":
        try:
            print("evaluate model korean")
            sac.evaluate_korean(model_path=args.model_path)
        except Exception as e:
            print(e)
