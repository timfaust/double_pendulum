...
from examples.reinforcement_learning.General.reward_functions import pos_reward, quadratic_rew, exp_distance_from_target, future_pos_reward, like_lqr
...
class GeneralEnv(CustomEnv):
    ...
    def __init__(
        ...
        self.initial_weights = [0.1, 0.05, 0.025, 0.06, 0.02, 0.005, 0.001, 0.0075]
    ...
    def get_reward(self, new_observation, action):
        reward = None
        if self.reward_name == "exp_distance_from_target":
